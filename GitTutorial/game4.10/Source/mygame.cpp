...
void CGameStateRun::OnInit()  								// 遊戲的初值及圖形設定
{
	...
	private:
		...
		int velocity;
		CAnimation animatoin;



		void CBouncingBall::SetXY(int z, int y)
		{
			this->x = x;
			this->y = y;
		}
	...
	*/
	...
	//practice.LoadBitmap(IDB_BITMILK);
	//
	// 完成部分Loading動作，提高進度
	//
	ShowInitProgress(50);
	...
	// 繼續載入其他資料
	//
	practice.LoadBitmap(IDB_BITMILK, RGB(255, 255, 255));
